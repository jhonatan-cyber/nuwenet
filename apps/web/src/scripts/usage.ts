...
import { buttonOutline, input, mutedNote, table, tableHead, tableCell } from '../lib/shadcn.js';
...
export function usageMarkup(includeControls=true){return `<section data-usage class="py-6" aria-label="Historial mensual de consumo">
