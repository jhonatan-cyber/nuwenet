...
//
// Uso: bun tools/ops/upgrade-rehearsal.ts [revisión]   (por defecto: la última
...
import { assertLegacySource, legacyRevision, legacySource } from '../db/legacy-revision';
import { tmpdir } from 'node:os';
import path from 'node:path';
import { pathToFileURL } from 'node:url';
import { randomBytes, randomUUID } from 'node:crypto';

// Qué revisión encarna la era heredada lo decide `tools/db/legacy-revision.ts`, que
