...
import { assertLegacySource, legacyRevision, legacySource, usesRegistry } from '../scripts/legacy-revision.mjs';
...
test('ensayo: una base entera real se actualiza entera', () => {
  const ensayo = spawnSync(process.execPath, ['scripts/upgrade-rehearsal.mjs'], { encoding: 'utf8', timeout: 240000 });
